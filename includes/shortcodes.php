...
?>
	...
	if ($the_query->have_posts()) {
		...
		$email_template_restricted =  isset($all_in_one_invite_codes_mail_templates['email_template_readonly']) ? $all_in_one_invite_codes_mail_templates['email_template_readonly'] ==='enabled' ? true : false: false;
	?>
...
function all_in_one_invite_codes_create($attr)
{
	...
	?>
	<div>
		<input type="hidden" name="tk_all_in_one_invite_code" id="tk_all_in_one_invite_code_modal" value="<?php echo esc_attr($all_in_one_invite_code); ?>">
